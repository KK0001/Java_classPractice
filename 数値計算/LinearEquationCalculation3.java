...
public class LinearEquationCalculation3{
  ...
  public static void main(String [] args) {
    ...
    double [][] square_matrix = { { 0.0142, -0.0820, 0.217, -0.00431, 0.307},
                                       { -0.0205, 0.141, 0.0390, 0.0219, -0.145},
                                       { 0.113, 0.00576, -0.188, 0.0140, -0.0741},
                                       { -0.0142, -0.102, 0.0123, 0.113, 0.0220},
                                        { -0.0939, 0.0283, 0.0773, 0.0735, 0.0879}};  //行列
